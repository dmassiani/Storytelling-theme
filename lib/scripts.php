...
function roots_scripts() {
  ...
  if (WP_ENV === 'development') {
    $assets = array(
      ...
      'lato'      => '//fonts.googleapis.com/css?family=Lato:100,300,400,700',
  ...
  wp_enqueue_style('lato', $assets['lato'], false, null);
  wp_enqueue_style('loots', get_template_directory_uri() . $assets['css'], false, null);
